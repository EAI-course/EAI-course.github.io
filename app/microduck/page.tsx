...
export default function MicroduckLab() {
  ...
  return <main className="duck-lab">
    <header className="duck-header"><a href="/">← Embodied AI course</a><nav aria-label="Microduck learning path"><a href="#mechanics">Mechanics</a><a href="#system">System</a><a href="#learn">Learn</a><a href="#local">Local setup</a><a href="https://github.com/pollen-robotics/microduck" target="_blank" rel="noreferrer">Upstream ↗</a><LocaleBridge/></nav></header>
